        ...
        <div class="flex items-center gap-4">
            @if(isset($_SESSION['user']))
                    <div x-data="{ open: false }" class="relative flex items-center gap-4">
                        ...
                        >
                            <a href="{{ APP_URL .'profile' }}" @click="open = false" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                Quản lý tài khoản
                            </a>
                            <a href="{{ APP_URL . 'logout' }}" @click="open = false" class="block px-4 py-2 text-sm text-red-500 hover:bg-red-100">
                                Đăng xuất
                            </a>
                        </div>
            </div>
            @else
                <a href="{{ APP_URL . 'login' }}" class="text-black-600 font-medium hover:underline"><span class="material-symbols-outlined">account_circle</span></a>
            @endif
